...
from DL_code.nets.CSPdarknet53 import darknet_body
...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    P3_output = DarknetConv2D(num_anchors*(num_classes+5), (1,1), kernel_initializer=keras.initializers.normal(mean=0.0, stddev=0.01),name="P3_out")(P3_output)
    ...
    P4_output = DarknetConv2D(num_anchors*(num_classes+5), (1,1), kernel_initializer=keras.initializers.normal(mean=0.0, stddev=0.01),name="P4_out")(P4_output)
    ...
    P5_output = DarknetConv2D(num_anchors*(num_classes+5), (1,1), kernel_initializer=keras.initializers.normal(mean=0.0, stddev=0.01),name="P5_out")(P5_output)
...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    #---------------------------------------------------#
    print("feats: ", feats)
    print("K.shape(feats)[1:3]: ", K.shape(feats)[1:3])
